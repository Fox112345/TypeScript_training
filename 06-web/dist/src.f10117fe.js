...
function (_super) {
  ...
  User.buildUser = function (attrs) {
    return new User(new Attributes_1.Attributes(attrs), new Eventing_1.Eventing(), new ApiSync_1.ApiSync(userUrl));
  };

  User.buildUserCollection = function () {
    return new Collection_1.Collection(userUrl, function (json) {
...
exports.User = User;
},{"./Eventing":"models/Eventing.ts","./ApiSync":"models/ApiSync.ts","./Attributes":"models/Attributes.ts","./Model":"models/Model.ts","./Collection":"models/Collection.ts"}],"views/CollectionView.ts":[function(require,module,exports) {
"use strict";
...
function (_super) {
  ...
  UserList.prototype.renderItem = function (model, itemPrent) {
    new UserShow_1.UserShow(itemPrent, model).render();
  };
...
},{"./CollectionView":"views/CollectionView.ts","./UserShow":"views/UserShow.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
users.fetch();
},{"../models/User":"models/User.ts","../views/UserList":"views/UserList.ts","../models/Collection":"models/Collection.ts"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
