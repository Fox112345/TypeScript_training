...
exports.controller = exports.bodyValidator = void 0;
...
function bodyValidator(keys) {
    return function (req, res, next) {
        if (!req.body)
            return res.status(422).send("Invalid req");
...
function controller(routerPrefix) {
    return function (target) {
        ...
        for (var key in target.prototype) {
            ...
            if (path) {
                router[method].apply(router, __spreadArrays([routerPrefix + path], middlewares, [validator,
                    routerHandler]));
            }
        }
    };
